...
#import "WAYPostsViewController.h"

#import "WAYCommentsViewController.h"
#import "WAYPostUtility.h"
#import "WAYPost.h"

@interface WAYPostsViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end

@implementation WAYPostsViewController
...
{
    NSLog(@"ici: %d", [[self.fetchedResultsController sections] count]);
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"WAYPost" inManagedObjectContext:self.managedObjectContext];
...
- (void)appplicationIsActive:(NSNotification *)notification {
    ...
    // Sync with web service
//    [MAOCategoryUtility fetchAndSyncCategoriesWithContext:[self.fetchedResultsController managedObjectContext] andObserver:self];
}
